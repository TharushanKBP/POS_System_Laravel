            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small" style="color: red;">Profit</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small" style="color: red;">Payments Net</div>
                    </div>
                </div>
            </div>
        </div>
