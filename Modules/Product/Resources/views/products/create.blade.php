                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_quantity" required value="{{ old('product_quantity') }}" min="0.01" step="0.01">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Alert Quantity <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="product_stock_alert" required value="{{ old('product_stock_alert', 0) }}" min="0.01" step="0.01">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="form-group">
                          ...
                          <div class="dropzone d-flex flex-wrap align-items-center justify-content-center" id="product-image-dropzone">
