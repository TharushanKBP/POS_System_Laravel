                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_quantity" required value="{{ $product->product_quantity }}" min="0.01" step="0.01">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Alert Quantity <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="product_stock_alert" required value="{{ $product->product_stock_alert }}" min="0.01" step="0.01">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="product_mf_date" name="product_mf_date" required value="{{ $product->product_mf_date }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_exp_date">Expired Date <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" id="product_exp_date" name="product_exp_date" required value="{{ $product->product_exp_date }}">
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    Dropzone.options.documentDropzone = {
        ...
        removedfile: function (file) {
            ...
            if (typeof file.file_name !== 'undefined') {
                name = file.file_name;
                removedImages.push(file.id); // Track removed images for deletion
            } else {
        ...
        init: function () {
            ...
            for (var i in files) {
                var file = files[i];
                file.id = file.id; // Set the file id for removal tracking
    ...
    // Add removed images to form submission
    $('form').submit(function () {
        removedImages.forEach(function (imageId) {
            $('form').append('<input type="hidden" name="image[]" value="' + imageId + '">');
        });
    });
</script>
